...
public struct MonsterVector : IFieldGroupVector<MonsterStruct> {
  ...
  public FieldGroupVectorEnumerator<MonsterStruct, MonsterVector> GetEnumerator() { return new FieldGroupVectorEnumerator<MonsterStruct, MonsterVector>(ref this); }
