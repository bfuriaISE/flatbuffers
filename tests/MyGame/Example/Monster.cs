...
public sealed class Monster : Table {
  ...
  public byte GetTestarrayofbytes(int j) { int o = __offset(54); return o != 0 ? bb.Get(__vector(o) + j * 1) : (byte)0; }
  public int TestarrayofbytesLength { get { int o = __offset(54); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayofbytesBytes() { return __vector_as_arraysegment(54); }
  public bool MutateTestarrayofbytes(int j, byte testarrayofbytes) { int o = __offset(54); if (o != 0) { bb.Put(__vector(o) + j * 1, testarrayofbytes); return true; } else { return false; } }
  public byte Testbyte2 { get { int o = __offset(56); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte2(byte testbyte2) { int o = __offset(56); if (o != 0) { bb.Put(o + bb_pos, testbyte2); return true; } else { return false; } }
  ...
  public byte Testbyte3 { get { int o = __offset(60); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte3(byte testbyte3) { int o = __offset(60); if (o != 0) { bb.Put(o + bb_pos, testbyte3); return true; } else { return false; } }
  public short GetTestarrayofshorts(int j) { int o = __offset(62); return o != 0 ? bb.GetShort(__vector(o) + j * 2) : (short)0; }
  public int TestarrayofshortsLength { get { int o = __offset(62); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayofshortsBytes() { return __vector_as_arraysegment(62); }
  public bool MutateTestarrayofshorts(int j, short testarrayofshorts) { int o = __offset(62); if (o != 0) { bb.PutShort(__vector(o) + j * 2, testarrayofshorts); return true; } else { return false; } }
  public byte Testbyte4 { get { int o = __offset(64); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte4(byte testbyte4) { int o = __offset(64); if (o != 0) { bb.Put(o + bb_pos, testbyte4); return true; } else { return false; } }
  public int GetTestarrayofints(int j) { int o = __offset(66); return o != 0 ? bb.GetInt(__vector(o) + j * 4) : (int)0; }
  public int TestarrayofintsLength { get { int o = __offset(66); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayofintsBytes() { return __vector_as_arraysegment(66); }
  public bool MutateTestarrayofints(int j, int testarrayofints) { int o = __offset(66); if (o != 0) { bb.PutInt(__vector(o) + j * 4, testarrayofints); return true; } else { return false; } }
  public byte Testbyte5 { get { int o = __offset(68); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte5(byte testbyte5) { int o = __offset(68); if (o != 0) { bb.Put(o + bb_pos, testbyte5); return true; } else { return false; } }
  public long GetTestarrayoflongs(int j) { int o = __offset(70); return o != 0 ? bb.GetLong(__vector(o) + j * 8) : (long)0; }
  public int TestarrayoflongsLength { get { int o = __offset(70); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayoflongsBytes() { return __vector_as_arraysegment(70); }
  public bool MutateTestarrayoflongs(int j, long testarrayoflongs) { int o = __offset(70); if (o != 0) { bb.PutLong(__vector(o) + j * 8, testarrayoflongs); return true; } else { return false; } }
  public byte Testbyte6 { get { int o = __offset(72); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte6(byte testbyte6) { int o = __offset(72); if (o != 0) { bb.Put(o + bb_pos, testbyte6); return true; } else { return false; } }
  public float GetTestarrayoffloats(int j) { int o = __offset(74); return o != 0 ? bb.GetFloat(__vector(o) + j * 4) : (float)0; }
  public int TestarrayoffloatsLength { get { int o = __offset(74); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayoffloatsBytes() { return __vector_as_arraysegment(74); }
  public bool MutateTestarrayoffloats(int j, float testarrayoffloats) { int o = __offset(74); if (o != 0) { bb.PutFloat(__vector(o) + j * 4, testarrayoffloats); return true; } else { return false; } }
  public byte Testbyte7 { get { int o = __offset(76); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte7(byte testbyte7) { int o = __offset(76); if (o != 0) { bb.Put(o + bb_pos, testbyte7); return true; } else { return false; } }
  public double GetTestarrayofdoubles(int j) { int o = __offset(78); return o != 0 ? bb.GetDouble(__vector(o) + j * 8) : (double)0; }
  public int TestarrayofdoublesLength { get { int o = __offset(78); return o != 0 ? __vector_len(o) : 0; } }
  public ArraySegment<byte>? GetTestarrayofdoublesBytes() { return __vector_as_arraysegment(78); }
  public bool MutateTestarrayofdoubles(int j, double testarrayofdoubles) { int o = __offset(78); if (o != 0) { bb.PutDouble(__vector(o) + j * 8, testarrayofdoubles); return true; } else { return false; } }
  public byte Testbyte8 { get { int o = __offset(80); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte8(byte testbyte8) { int o = __offset(80); if (o != 0) { bb.Put(o + bb_pos, testbyte8); return true; } else { return false; } }
  public byte Testbyte1 { get { int o = __offset(82); return o != 0 ? bb.Get(o + bb_pos) : (byte)0; } }
  public bool MutateTestbyte1(byte testbyte1) { int o = __offset(82); if (o != 0) { bb.Put(o + bb_pos, testbyte1); return true; } else { return false; } }
  ...
  public static void AddTestarrayofbytes(FlatBufferBuilder builder, VectorOffset testarrayofbytesOffset) { builder.AddOffset(25, testarrayofbytesOffset.Value, 0); }
  ...
  public static void AddTestbyte2(FlatBufferBuilder builder, byte testbyte2) { builder.AddByte(26, testbyte2, 0); }
  ...
  public static void AddTestbyte3(FlatBufferBuilder builder, byte testbyte3) { builder.AddByte(28, testbyte3, 0); }
  public static void AddTestarrayofshorts(FlatBufferBuilder builder, VectorOffset testarrayofshortsOffset) { builder.AddOffset(29, testarrayofshortsOffset.Value, 0); }
  ...
  public static void AddTestbyte4(FlatBufferBuilder builder, byte testbyte4) { builder.AddByte(30, testbyte4, 0); }
  public static void AddTestarrayofints(FlatBufferBuilder builder, VectorOffset testarrayofintsOffset) { builder.AddOffset(31, testarrayofintsOffset.Value, 0); }
  ...
  public static void AddTestbyte5(FlatBufferBuilder builder, byte testbyte5) { builder.AddByte(32, testbyte5, 0); }
  public static void AddTestarrayoflongs(FlatBufferBuilder builder, VectorOffset testarrayoflongsOffset) { builder.AddOffset(33, testarrayoflongsOffset.Value, 0); }
  ...
  public static void AddTestbyte6(FlatBufferBuilder builder, byte testbyte6) { builder.AddByte(34, testbyte6, 0); }
  public static void AddTestarrayoffloats(FlatBufferBuilder builder, VectorOffset testarrayoffloatsOffset) { builder.AddOffset(35, testarrayoffloatsOffset.Value, 0); }
  ...
  public static void AddTestbyte7(FlatBufferBuilder builder, byte testbyte7) { builder.AddByte(36, testbyte7, 0); }
  public static void AddTestarrayofdoubles(FlatBufferBuilder builder, VectorOffset testarrayofdoublesOffset) { builder.AddOffset(37, testarrayofdoublesOffset.Value, 0); }
  ...
  public static void AddTestbyte8(FlatBufferBuilder builder, byte testbyte8) { builder.AddByte(38, testbyte8, 0); }
  public static void AddTestbyte1(FlatBufferBuilder builder, byte testbyte1) { builder.AddByte(39, testbyte1, 0); }
